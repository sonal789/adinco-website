...
<section class="eventsection no-padding float-left" style="background:#000;    width: 100%;">
	...
	<div class="grid">	
		<div class="grid-item ">
			<?php if(get_field('grid1', $ID)){ ?>
			<div class="sblock-t grid1"><img src="<?php  the_field('grid1', $ID); ?>" ></div>
			<?php } else { ?>
			<div class="sblock-t text-left grid1">
				<div class="gtext">
				<div class="gdate"><?php 
					$eventdate = get_field('event_date', $ID);
					echo date("d F Y", strtotime($eventdate));
			...
			<?php } ?>
			<div class="sblock-b grid2"><img src="<?php the_field('grid2', $ID); ?>" ></div>
		</div>	
		<div class="grid-item2">
			<div class="bblock">
				<img src="<?php the_field('event_background_image', $ID); ?>" >
				<?php if(get_field('grid1', $ID)){ ?>
		...
		<div class="grid-item">
			<div class="sblock-t grid1"><img src="<?php  the_field('grid4', $ID); ?>" ></div>
			<div class="sblock-b grid1"><img src="<?php the_field('grid5', $ID); ?>" ></div>
		</div>
		<div class="grid-item">
			<div class="sblock-t grid1"><img src="<?php the_field('grid6', $ID); ?>" ></div>
			<div class="sblock-b grid1"><img src="<?php the_field('grid7', $ID); ?>" ></div>
		</div>
	</div>
...
<?php global $wp_query;
					$post->ID = 7;
					?>
<section class="h-cta" style="background:#000;" data-aos="zoom-in">
	<div class="subscribe">
